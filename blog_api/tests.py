...
class PostTests(APITestCase):
    ...
    def test_view_posts(self):
        ...
        # listcreate ở đây là cái name của cái api mà viết trong blog_api
    ...
    def test_post_update(self):
        ...
        # test_post này mặc dù ko đc dùng ở dưới, nhưng mà chỗ này giống kiểu tạo ra data cho database
        client.login(username=self.testuser1.username,
                     password='123456789')
        # nếu chỗ này mà login user2 sẽ bị sai
